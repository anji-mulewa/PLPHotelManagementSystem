...
public class AdminStepDefination {
	...
	public void admin_click_on_hotel_list_update_button() throws Throwable {
		driver.findElement(By.xpath(
				"/html/body/app-root/app-vertical-header/mat-sidenav-container/mat-sidenav-content/app-admin-hotel-list/div[2]/div/div/button[2]"))
				.click();
		Thread.sleep(6000);
	}
	...
	public void admin_click_on_room_list_update_button() throws Throwable {
		driver.findElement(By.xpath(
				"/html/body/app-root/app-vertical-header/mat-sidenav-container/mat-sidenav-content/app-admin-room-list/div[10]/div/div/button[2]"))
				.click();
		Thread.sleep(6000);
	}
	...
	public void admin_enter_add_employee_valid_data() throws Throwable {
		driver.findElement(By.name("licenceNumber")).sendKeys("H78965412");
